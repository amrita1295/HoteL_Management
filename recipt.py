...
fo1=open("recipt.txt","r")       #opening the recipt notepad to read the lines
list1=fo1.readlines()

del list1[1]       # deleting earlier data and recording new one
del list1[2]
del list1[3]
del list1[4]
del list1[5]
...
class recipt:
    def __init__(self):           #class created and constructor
        root=Tk()
