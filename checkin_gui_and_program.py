...
class HOTEL_MANGMENT_checkin:   #PROGRAM STARTS FROM HERE******************************AFTER THE MAIN 
    ...
    def __init__(self):
        ...
        def submit_clicked():
            if self.var1.get()==1 and self.var2.get()==0 and self.var3.get()==0 and self.var4.get()==0 and self.var5.get()==1 and self.var6.get()==0:
                ...
                enter(self)              #calling these functions
                tor(self)
                payment_option(self)
                bill(self)
        ...
        self.Frame1 = Frame(root)        #frame created
        ...
        self.Frame2 = Frame(root)        #frame 2 created
